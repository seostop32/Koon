...
function PrivacyPolicy() {
  return (
    <div style={{   maxWidth: '768px',
                    ...
                    color: '#333',
                    fontSize: '0.9rem',     // 폰트 사이즈 통일
                    lineHeight: '1.7' }}>
      <h3 style={{ textAlign: 'center', color: '#e91e63', marginBottom: 20 }}>개인정보 처리방침</h3>
      ...
      <h3 style={{ marginTop: 30, color: '#c2185b' }}>1. 개인정보 수집 항목 및 방법</h3>
      ...
      <h3 style={{ marginTop: 30, color: '#c2185b' }}>2. 개인정보의 이용 목적</h3>
      <p style={{ lineHeight: 1.6 }}>
      ...
      <h3 style={{ marginTop: 30, color: '#c2185b' }}>3. 개인정보 보유 및 이용 기간</h3>
      <p style={{ lineHeight: 1.6 }}>
        원칙적으로 개인정보의 보유 기간은 회원 탈퇴 시까지이며, 관계 법령에 따라 일정 기간 보관 후 안전하게 파기합니다.
      </p>

      <h3 style={{ marginTop: 30, color: '#c2185b' }}>4. 개인정보 보호를 위한 조치</h3>
      <p style={{ lineHeight: 1.6 }}>
        저희는 개인정보를 안전하게 관리하기 위해 기술적, 관리적 조치를 실시하고 있습니다.
        암호화, 접근 통제, 보안 시스템 도입 등을 통해 개인정보를 보호합니다.
      </p>

      <h3 style={{ marginTop: 30, color: '#c2185b' }}>5. 이용자의 권리</h3>
      <p style={{ lineHeight: 1.6 }}>
