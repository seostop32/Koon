...
function DashboardHeader() {
  ...
  const [messageAlertEnabled, setMessageAlertEnabled] = useState(true); // 기본값 true
...
console.log('totalUnread:', unreadMessageCount + unreadNotificationCount);
  ...
  // BellButton 컴포넌트
    function BellButton({ unreadCount, onClick }) {
      console.log('✅ messageAlertEnabled:', messageAlertEnabled);
      return (
  ...
  return (
    <div style={styles.header}>
      ...
      <div style={styles.buttonGroup}>
        ...
        <BellButton unreadCount={
            (messageAlertEnabled ? unreadMessageCount : 0) + unreadNotificationCount
          }
